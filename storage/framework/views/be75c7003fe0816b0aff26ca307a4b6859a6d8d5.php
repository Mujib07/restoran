...
<?php $__env->startSection('lib'); ?>
  ...
  <script type="text/javascript" src="<?php echo asset('public/js/chart.min.js'); ?>"> </script>
  <script type="text/javascript" src="<?php echo asset('public/js/line-chart.js'); ?>"> </script>
<?php $__env->stopSection(); ?>
